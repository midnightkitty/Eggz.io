...
var game = new Phaser.Game(800, 600, Phaser.HEADLESS, 'phaser-example', { preload: preload, create: create, update:update });

function preload() {
    //console.log('preload');
    //console.log(__dirname + '\\bullet.png');
...
function create() {
	//console.log(game.cache.getPhysicsData('player'));
